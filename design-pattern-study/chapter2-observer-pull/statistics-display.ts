...
export class StatisticsDisplay implements Observer, DisplayElement{
    ...
    update() {
        this.tempStatistics.update(this.weatherData.getTemperature());
        this.humidityStatistics.update(this.weatherData.getHumidity());
        this.pressureStatistics.update(this.weatherData.getPressure());
    }
